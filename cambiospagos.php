...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Estados de cuenta</h1>
          </div>
            ...
            <div class="col-xl-12 col-lg-11">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Generar estados decuenta</h6>
                ...
                <div class="card-body">
                    ...
                    <form id="edoCte">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input filtroCta" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1">
                            <label class="form-check-label" for="inlineRadio1">Correcciones</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input filtroCta" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2">
                            <label class="form-check-label" for="inlineRadio2">Actualizar pagos</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table class="table table-bordered display" id="detPagos">
                              <thead>
                                <tr>
                                  <th scope="col">Id</th>
                                  <th scope="col">Mes factura</th>
                            ...
                            <br>
                            <button type="button" id="actualizarDato" class="btn btn-info accionCtes" disabled="disabled">Aplicar</button>
                        </div>
                    </div>
  ...
  <div class="modal fade" id="ModalAcualizacion" tabindex="-1" role="dialog" aria-labelledby="actualizar" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tituloActualizar">Modificando pago</h5>
          ...
          <div class="modal-body">
            ...
            <form id="modificar">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fechaPago" placeholder="D-M-AAAA">
                </div>
                
                <button id="aplicarCambio" type="button" class="btn btn-primary">Actualizar</button>
  ...
  <script src="js/correcciones.js"></script>
