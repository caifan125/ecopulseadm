...
<body id="page-top">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="cobros">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="divisa">Divisa de pago</label>
                            <select id="divisa" class="form-control">
                              <option value="" selected>Seleccionar...</option>
                              <option value="484">Peso mexicano (MXN)</option>
                              <option value="840">Dola americano (USD)</option>
                            </select>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="detCargos" class="table table-hover">
                              <thead>
                                <tr>
                            ...
                            <button id="crearReporte" type="button" class="btn btn-primary" disabled="disabled">Generar</button>
                        </div>
                    </div>
  ...
  <script src="js/operacionesTarjetas.js"></script>
