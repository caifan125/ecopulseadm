...
<body id="page-top">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <br>
                            <form id="generarEdoCta" method="post" action="controlador/controlador.php" target="_blank">
                                <div class="form-group">
                                    <label for="aliquidar">A pagar si liquida el total</label>
                                    <input type="text" class="form-control" id="aliquidar" disabled="disabled">
                                </div>
                                <input id="enviarCta" class="btn btn-primary" type="submit" name="enviar" value="Generar" disabled="disabled">
                            </form>
                        </div>
                    </div>
  ...
  <script src="js/estadosCta.js"></script>
