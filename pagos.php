...
<body id="page-top">
                ...
                <div class="card-body">
                    ...
                    <form id="altaPago">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="mesFactura">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="fechaDep" placeholder="D-M-AAAA">
                        </div>
                        <div class="form-group">
  ...
  <script src="js/pagosCte.js"></script>
